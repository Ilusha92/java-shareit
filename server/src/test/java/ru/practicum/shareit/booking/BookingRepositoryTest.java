...
public class BookingRepositoryTest {
    ...
    public void beforeEach() {
        ...
        booking = bookingRepository
                .save(new Booking(null, start, end, item, booker,status));
    }
    ...
    public void findByBookerIdAndStatusTest() {
        Page<Booking> result = bookingRepository
                .findByBookerIdAndStatus(booker.getId(), status, Pageable.unpaged());
    ...
    @Test
    public void findBookingByItemOwnerIdAndStatusTest() {
        Page<Booking> result = bookingRepository
                .findBookingByItemOwnerIdAndStatus(itemOwner.getId(), status, Pageable.unpaged());
    ...
    public void findBookingByItemIdAndEndBeforeTest() {
        List<Booking> result = bookingRepository
                .findBookingByItemIdAndStartBeforeAndStatus(item.getId(), LocalDateTime.now().plusDays(30), Sort.unsorted(), Status.APPROVED);
    ...
    public void findBookingByItemIdAndStartAfterTest() {
        List<Booking> result = bookingRepository
                .findBookingByItemIdAndStartAfterAndStatus(item.getId(), LocalDateTime.now(), Sort.unsorted(), Status.APPROVED);
